...
%\begin{figure}[htb]
%	\centering
%	\includegraphics[width=0.5\linewidth]{images/k4-alu.JPG}
%	\caption{Variante 4: Die Kapsel ist in einen Alurahmen geklebt, um eine Kastenform zu erhalten}
%	\label{fig:k4_alu}
%\end{figure}
...
% Noch Bilder von der Anlage beim Messen? Kapsel auf Sortierband ect 
