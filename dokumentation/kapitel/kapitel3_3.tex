...
Abgelegt werden die Files mit einem bestimmten Namensformat. Sie beginnen mit dem aktuellen Timestamp um identische Filenamen zu verhinden. Zusätzlich wird noch der Bereich %TODO welcher Bereich? ist nicht ganz eindeutig 
